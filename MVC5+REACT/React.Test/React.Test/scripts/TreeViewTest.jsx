    ...
    var Button = React.createClass({
        render: function() {
            return (
                <div className="row" >
                    <button className="btn btn-default">Save Checked Nodes</button>
                </div>  
          );
        }
    });
    ...
    var TreeView = React.createClass({
        ...
        render: function () {
            return (
              <div className="row">
                    <div id="treeDiv" ref="treeRef"></div>
              </div>
          );
        }
});
    ...
    var TreeViewBox = React.createClass({
        render: function () {
            return (
                <div  className="container-fluid">
                <Button/>
                <TreeView sourceUrl = {this.props.sourceUrl}/>
            </div>
          )      
        }
});
...
ReactDOM.render(
    <TreeViewBox sourceUrl = "/React.Test/location/get" />,
    //<CommentBox url="/React.Test/comments" />,//Get data from server
